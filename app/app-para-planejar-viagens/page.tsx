  ...
  return (
    <div className="min-h-screen bg-secondary-bg text-primary-text font-sans">
      ...
      <section className="max-w-6xl mx-auto px-6 py-20 flex flex-col md:flex-row items-center gap-12">
        ...
        Aposente o Excel e o Word
        </span>
        <h1 className="font-outfit text-5xl md:text-6xl font-bold leading-tight text-primary-text">
        O app inteligente para<br />planejar suas viagens.
        </h1>
        <p className="text-lg text-secondary-text max-w-lg">
        Pare de perder links e horários. O Trix centraliza passagens, hotéis e cria o itinerário lógico para cada dia da sua viagem. Tudo em um só lugar.
        </p>
          
          <WaitlistForm source="app-para-planejar-viagens_hero" variant="hero" />
        </div>
      ...
      <section className="max-w-4xl mx-auto px-6 py-24 text-center">
        ...
        <WaitlistForm source="app-para-planejar-viagens_cta" variant="cta" />
      </section>
