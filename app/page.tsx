  ...
  return (
    <div className="min-h-screen bg-secondary-bg text-primary-text font-sans">
        ...
        <div className="flex-1 space-y-6">
          ...
          <form onSubmit={handleSubscribe} className="flex flex-col sm:flex-row gap-3 w-full max-w-md">
            ...
            <button
              type="submit"
              disabled={loading}
              className="px-6 py-3 bg-primary text-info font-medium rounded-lg hover:opacity-90 transition-opacity disabled:opacity-50"
            >
          ...
          {message && (
            <p className={`text-sm font-medium ${message.type === 'success' ? 'text-secondary' : 'text-tertiary'}`}>
              {message.text}
            </p>
          )}
        </div>
      ...
      <section className="bg-primary-bg py-24">
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-3 gap-12">
            <div className="bg-secondary-bg p-8 rounded-xl shadow-sm border border-alternate">
              ...
              <h3 className="text-xl font-semibold mb-3 text-primary-text">Logística à prova de falhas.</h3>
            ...
            <div className="bg-secondary-bg p-8 rounded-xl shadow-sm border border-alternate">
              ...
              <h3 className="text-xl font-semibold mb-3 text-primary-text">O seu ritmo, as suas regras.</h3>
              <p className="text-secondary-text leading-relaxed">
            ...
            <div className="bg-secondary-bg p-8 rounded-xl shadow-sm border border-alternate">
              ...
              <h3 className="text-xl font-semibold mb-3 text-primary-text">O fim das planilhas.</h3>
              <p className="text-secondary-text leading-relaxed">
      ...
      <section className="max-w-4xl mx-auto px-6 py-24 text-center">
        <h2 className="text-3xl md:text-4xl font-bold mb-4 text-primary-text">Pronto para viajar melhor?</h2>
      ...
      <footer className="border-t border-alternate bg-secondary-bg py-12">
        <div className="max-w-6xl mx-auto px-6 flex flex-col md:flex-row justify-between items-center gap-6">
          <div className="flex items-center gap-2">
            <span className="font-semibold text-secondary-text text-lg">Trix Travel</span>
          </div>
